                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel"
                        ...
                        <div style="margin: 10px;">
                            <a style="font-size: 2rem;">{{ admin('App Management') }} | </a> <a
                                style="font-size: 1rem;">{{ $settings->name }}</a>
                        </div>
                    </li>
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel"
                        data-menu-toggle="click" aria-haspopup="true" >
...
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="menu-item menu-item-submenu {{ Request::segment(3) == 'static_pages' ?  'menu-item-active' : '' }}"--}}
...
{{--                                                            <span></span>--}}
{{--                                                        </i>--}}
{{--                                                        <span class="menu-text">{{admin('No Data Found')}}</span>--}}
{{--                                                    </a>--}}
{{--                                                </li>--}}
{{--                                            @endforelse--}}
{{--                                        </ul>--}}
...
{{--                    </li>--}}
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M18,13 C19.1045695,13 20,12.1045695 20,11 C20,9.8954305 19.1045695,9 18,9 C16.8954305,9 16,9.8954305 16,11 C16,12.1045695 16.8954305,13 18,13 Z M18,15 C15.790861,15 14,13.209139 14,11 C14,8.790861 15.790861,7 18,7 C20.209139,7 22,8.790861 22,11 C22,13.209139 20.209139,15 18,15 Z" fill="#000000" fill-rule="nonzero"/>
                                    ...
                                    class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">{{admin('Pages')}}</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-circle"
                             src="{{currentLanguage() == 'ar' ? asset('assets/media/flags/133-saudi-arabia.svg'): asset('assets/media/flags/226-united-states.svg')}}"
                             alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item {{currentLanguage() == 'ar'?'active':''}}">
                            <a href="{{url('admin/locale/ar')}}" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img class="rounded-circle"
                                                             src="{{asset('assets/media/flags/133-saudi-arabia.svg')}}"
                                                             alt=""/>
													</span>
                        ...
                        <li class="navi-item {{currentLanguage() == 'en'?'active':''}}">
                            <a href="{{url('admin/locale/en')}}" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img class="rounded-circle"
