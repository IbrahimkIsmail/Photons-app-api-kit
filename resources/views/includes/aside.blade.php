<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand  flex-column-auto" id="kt_brand" style="background-color: white">
        ...
        <div class="brand-logo">
            <a href="{{route('home')}}">
                <center>
                <img alt="Logo" src="{{ asset('/assets/media/logos/logo_s.png') }}" style="width: 30%;height: 80%">
                </center>
            </a>
        </div>
...
{{--        </a>--}}
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item  {{ Request::is('web') || Request::is('/home')? 'menu-item-active' : '' }} " aria-haspopup="true">
                    <a href="{{route('home')}}" class="menu-link">
                        ...
                        <span class="menu-text">{{web('Home')}}</span>
                    </a>
                </li>
                <li class="menu-section">
                    <h4 class="menu-text">{{web('Menu')}}</h4>
               ...
               {{-- <li class="menu-item menu-item-submenu {{ Request::segment(2) == 'countries' ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true"
                ...
                <li class="menu-item menu-item-submenu {{ Request::segment(2) == 'categories' ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true"
                    ...
                    <a href="{{route('categories.index')}}" class="menu-link menu-toggle">
                        <span class="menu-icon">
                            <i class="fab fa-fort-awesome text-success"> </i>
                        </span>
                        <span class="menu-text">{{admin('Categories')}}</span>

                    </a>
                </li>
                <li class="menu-item menu-item-submenu {{ Request::segment(2) == 'recipes' ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true"
                data-ktmenu-submenu-toggle="hover">
                <a href="{{route('recipes.index')}}" class="menu-link menu-toggle">
                    <span class="menu-icon">
                        <i class="fab fa-fort-awesome text-success"> </i>
                    </span>
                    <span class="menu-text">{{admin('Recipes')}}</span>
