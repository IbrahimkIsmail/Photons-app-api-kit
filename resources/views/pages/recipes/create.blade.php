            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                            <a class="text-dark"
                               href="{{route('recipes.create')}}">{{web('New Record')}}</a>
                        </span>
                    </div>
                </div>
                <!--end::Details-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                <h3 class="card-title">{{web('New Record')}}</h3>
                            </div>
                            <!--begin::Form-->
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                       ...
                                       <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input type="number" min="1" class="form-control" name="cooking_time">
                                            </div>
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div data-repeater-list="ingredients" class="col-lg-10">
                                            <div data-repeater-item="" class="form-group row align-items-center">
                                                <div class="col-md-6">
                                                    <input type="text" name='ingredients[number][input]' class="form-control" placeholder="Enter full name">
                                   ...
                                   <div id="kt_repeater_2">
                                    <div class="form-group row">
                                        ...
                                        <div data-repeater-list="prepares" class="col-lg-10">
                                            <div data-repeater-item="" class="form-group row align-items-center">
                                                <div class="col-md-6">
                                                    <input type="text" name='prepares[number][input]' class="form-control" placeholder="Enter full name">
                                                    <div class="d-md-none mb-2"></div>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="javascript:;" data-repeater-delete="" class="btn btn-sm font-weight-bolder btn-light-danger">
                    ...
                    document.getElementById('add_form'),
                    {
                        fields: {
                            ...
                            name: {
                                validators: {
                                    notEmpty: {
                                        message: "{{web(' Name is required')}}"
                                    },
                                    stringLength: {
                                        min: 2,
                                        message: "{{web('Name at least must be 2 digits')}}"
                                    }
                                }
                            },
