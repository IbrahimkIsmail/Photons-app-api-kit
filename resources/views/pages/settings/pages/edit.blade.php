                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                             <a class="text-dark"
                                href="{{route('admin.pages.edit',$page->id)}}">{{$page->title}}</a>
                        </span>
                    </div>
                    <!--end::Search Form-->
                </div>
                            ...
                            <form class="form" id="edit_form">
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <select name="type" class="form-control">
                                                    <option value="user" @if ($page->type == 'user') selected @endif>{{ admin('User App') }}</option>
                                                    <option value="dealer" @if ($page->type == 'dealer') selected @endif>{{ admin('Dealer App') }}</option>
                                                    <option value="web" @if ($page->type == 'web') selected @endif>{{ admin('Web') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </dev>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <label>{{admin('Title') . ' ' . $locale }}</label>
                                            <span style="color: red;"> * </span>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="title_{{ $locale }}"
                                                       value="{{$page->getOriginal('title')[$locale]}}">
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
