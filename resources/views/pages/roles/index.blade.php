                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                              <a class="text-dark"
                                 href="{{route('admin.roles.index')}}">{{admin('Roles')}}</a>
                        </span>
                        </div>
...
@section('scripts')
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admin/roles/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
                                {{--x = x + '<a type="submit" href="/admintz/categories/details/' + full.id + '"style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-info btn-elevate btn-pill btn-elevate-air la la-eye fa-lg" id="details_btn" title="{{admin('View')}}"></a>';--}}
                                    {{--    x = x + '<a  type="submit" href="/admin/subCategories/' + full.id + '"style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-dark btn-elevate btn-pill btn-elevate-air flaticon2-tag fa-lg" id="details_btn" title="{{admin('Sub Categories')}}"></a>';--}}
    ...
    <script>
        ...
        function disableTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admin/specializations/disable",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
        ...
        function activateTableRow(id, swal) {
            var table = $('#kt_datatable').DataTable();
            $.ajax({
                url: "/admin/specializations/activate",
                type: "post",
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
