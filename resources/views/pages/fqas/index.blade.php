                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">{{admin('FAQ')}}</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            <a href="{{route('admin.fqas.create')}}"
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'question', "className": "text-center", orderable: false,},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, full, meta) {
                                var x = '<a  href="/admin/fqa/edit/' + full.id + '" type="submit" style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-success btn-elevate btn-pill btn-elevate-air la la-edit fa-lg" id="edit_btn" title="{{admin('Edit')}}"></a>';
                                {{--x = x + '<a type="submit" href="/admintz/settings/faqs/details/' + full.id + '"style="margin:1px;" class="btn btn-sm btn-icon btn-icon-md btn-info btn-elevate btn-pill btn-elevate-air la la-eye fa-lg" id="details_btn" title="{{admin('View')}}"></a>';--}}
